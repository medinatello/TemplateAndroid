...
Este módulo corresponde al **MVP 08** del proyecto.  En este sprint se
continúa el desarrollo de nuevas funcionalidades, aprovechando las bases
construidas hasta el MVP 07.  El objetivo es seguir fortaleciendo la
plantilla multiplataforma y asegurar que el código siga siendo modular,
testeable y bien documentado.

## Objetivo principal

Implementar las historias de usuario asignadas al sprint 8, integrando
...
1. **Revisión de contexto**: Lee la documentación en
   `Cases/Documentation Main`, repasa el trabajo realizado hasta el MVP 07
...
Al completar el sprint, la carpeta `MVP-08` deberá contener todos los
